...
import pro.linguistcopilot.core.utils.screenshot
import pro.linguistcopilot.features.reader.presentation.view3.api.DataSource
import pro.linguistcopilot.features.reader.presentation.view3.delegate.CoverPageDelegate
import pro.linguistcopilot.features.reader.presentation.view3.delegate.NoAnimPageDelegate
import pro.linguistcopilot.features.reader.presentation.view.delegate.PageDelegate
import pro.linguistcopilot.features.reader.presentation.view3.delegate.ScrollPageDelegate
import pro.linguistcopilot.features.reader.presentation.view3.delegate.SimulationPageDelegate
import pro.linguistcopilot.features.reader.presentation.view3.delegate.SlidePageDelegate
import pro.linguistcopilot.features.reader.presentation.view3.entities.PageDirection
...
class ReadView(context: Context, attrs: AttributeSet) :
    ...
    DataSource {
    // колбеки для внешних элементов
    var callBack: CallBack? = null
    // припрнимаеи дадасорс
...
//            8 -> activity?.showDialogFragment(ContentEditDialog())
    ...
    fun upPageAnim() {
        ...
        (pageDelegate as? ScrollPageDelegate)?.noAnim = false
    }
