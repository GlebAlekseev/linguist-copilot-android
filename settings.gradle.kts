...
include(":feature:textProcessing:api")
include(":feature:textProcessing:impl")
include(":feature:translate:api")
include(":feature:translate:impl")
include(":feature:transcription:api")
include(":feature:transcription:impl")
include(":feature:word:api")
include(":feature:word:impl")
include(":feature:settings:api")
include(":feature:settings:impl")
include(":core:python:testapp")
